...
//    }
    ...
    public TheRequestBuilder url(HttpUrl url) {
        builder.url(url);
        return this;
    }
    public TheRequestBuilder url(String url) {
        builder.url(url);
        return this;
    }
    public TheRequestBuilder url(URL url) {
        builder.url(url);
        return this;
    }
    ...
    public <T extends Callback>void start(String url, T callback){
        okHttpClient.newCall(url(url).build()).enqueue(callback);
    }
